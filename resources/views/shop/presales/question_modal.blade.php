<form method="POST" action="/shop/presales/{{$lead->hash}}/questions">
    @csrf
    @method('POST')
    ...
    <div class="row mt-2">
        <div class="col-xxl-6">
            <input type="submit" class="btn theme-bg-color btn-md fw-bold text-light w-100" value="Save Questionnaire"/>
        </div>
    </div>
</form>
