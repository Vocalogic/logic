                        ...
                        <div class="row g-2">
                            <div class="col-md-12 col-12">
                                <div class="form-floating">
                                    ...
                                    <span
                                        class="helper-text mt-2">Enter markdown-enabled description for shop details.
                                        @if(setting('quotes.openai'))
                                            <a class="confirm"
                                               data-message="WARNING! This will rewrite your marketing description once confirmed. You should
                                   copy/paste your existing marketing description should you decide not to use the description generated by AI."
                                               data-method="GET"
                                               data-title="Overwrite with AI?"
                                               data-loading="Querying GPT for Marketing Info"
                                               data-confirm="Continue Using AI"
                                               href="/admin/category/{{$item->category->id}}/items/{{$item->id}}/ai?mode=marketing">
                    ...
                    <div class="row mt-3">
                        <div class="col-lg-12">
                            ...
                            <div class="form-floating">
                                ...
                                <span class="helper-text">Enter a bulleted list of features for this product.
                                    @if(setting('quotes.openai'))
                                        <a class="confirm"
                                           data-message="WARNING! This will rewrite your feature list once confirmed. You should
                                   copy/paste your existing feature list should you decide not to use the description generated by AI."
                                           data-method="GET"
                                           data-title="Overwrite with AI?"
                                           data-loading="Querying GPT for Feature Bullets"
                                           data-confirm="Continue Using AI"
                                           href="/admin/category/{{$item->category->id}}/items/{{$item->id}}/ai?mode=features">
                                    <i class="fa fa-expand"></i> Generate using AI
                                </a>
                                    @endif</span>
                            </div>
