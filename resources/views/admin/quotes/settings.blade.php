      ...
      <form method="post" action="/admin/quotes/{{$quote->id}}">
          ...
          <div class="row g-3 mb-4">
              <div class="col-lg-12 col-md-12">
                  ...
                  <input type="submit" name="submit" value="Save" class="btn btn-{{bm()}}primary wait mt-2">
                  <a class="btn btn-{{bm()}}danger mt-2 pull-right" data-bs-toggle="modal" href="#declineModal">
