    ...
    <div class="row">
        <div class="col-lg-12">
            @if(!$order->hasBeen(\App\Enums\Core\OrderStatus::Verified))
                <a class="confirm btn btn-info" data-message="Are you sure you want to verify this order?"
                   data-method="GET"
        ...
        <div class="col-lg-8 mt-2">
            @if($order->items()->where('product', 0)->count())
                <div class="card mb-3 fieldset border border-muted">
                    <h6 class="p-3">Service Orders</h6>
                    <div class="card-body">
            ...
            @if($order->items()->where('product', 1)->count())
                <div class="card mt-3 fieldset border border-muted">
                    <h6 class="p-3">Product Orders</h6>
                    <div class="card-body">
        ...
        <div class="col-lg-4">
            @if($order->active)
                <a href="/admin/orders/{{$order->id}}/send"
                   class="confirm btn btn-info mb-3"
                ...
                <a
                    class="btn btn-danger pull-right text-white confirm mb-3"
