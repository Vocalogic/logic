@extends('layouts.admin', ['title' => $term->name ?: "Create Service Terms"])


@section('pre')
    <div class="row align-items-center">
        <div class="col-auto">
            <h1 class="fs-5 color-900 mt-1 mb-0">{{$term->name?: "Create Service Terms"}}</h1>
            <small class="text-muted">{{$term->name?"Manage your": "Create new"}} Terms of Service for
