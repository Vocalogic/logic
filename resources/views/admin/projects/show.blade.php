                ...
                <div class="card bg-primary">
                    <div class="card-body p-0">
                        ...
                        <div class="row align-items-end">
                            <div class="col-sm-8">
                                <div class="p-3">
                                    <p class="fs-16 lh-base text-white">There is currently <span class="fw-semibold">${{moneyFormat($project->unbilledTime)}}</span> in unbilled time on this project.
                                      </p>
                                    <div class="mt-3">
                                        <a href="/admin/projects/{{$project->id}}/processtime" class="btn btn-info confirm"
