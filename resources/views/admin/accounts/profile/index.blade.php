<div class="row">
    <div class="col-lg-8">
        <a class="btn btn-{{bm()}}danger live" data-title="Cancel {{$account->name}}"
            ...
            <div class="card-body">
                <form method="post" action="/admin/accounts/{{$account->id}}">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="form-floating">
                                <input type="text" class="form-control" name="address2" value="{{$account->address2}}">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-lg-3 col-md-12">
                            <div class="form-floating">
                                <input type="text" class="form-control" name="state" value="{{$account->state}}">
                                <label>State</label>
    ...
    <div class="col-lg-4">
        ...
        <div class="card mt-2">
            <div class="card-body">
                <p>
                    If you would like for invoices and other billing emails to go to a specific email address, you can
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="form-floating">
                                ...
                                <span class="helper-text">Leave blank to use admin user for accounting.</span>
                            </div>
                        </div>
            ...
            @if($account->is_partner)
                <div class="card border-warning">
                    <div class="card-body">
                        <p>
                            {{$account->name}} is currently not enabled as a partner and cannot register leads or have
                            commissions tracked.
